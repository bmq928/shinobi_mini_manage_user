...
user from shinobi
{
    "$user": {
        "ok": true,
        "auth_token": "14aca6d881ab6aa5da0dedba73fe7146",
        "ke": "uet",
        "uid": "cpdpKfLkqz",
        "mail": "shinobi@vnu.edu.vn",
        "details": "{\"factorAuth\":\"0\",\"size\":\"\",\"days\":\"\",\"event_days\":\"\",\"log_days\":\"\",\"lang\":\"en_CA\",\"mon_groups\":\"\",\"webdav_url\":\"\",\"webdav_user\":\"\",\"webdav_pass\":\"\",\"webdav_save\":\"0\",\"webdav_dir\":\"\",\"ldap_enable\":\"0\",\"ldap_url\":\"\",\"ldap_bindDN\":\"\",\"ldap_bindCredentials\":\"\",\"ldap_searchFilter\":\"\",\"ldap_searchBase\":\"\",\"css\":\"\",\"get_server_log\":\"1\",\"permissions\":\"all\",\"edit_size\":\"1\",\"edit_days\":\"1\",\"use_admin\":\"1\",\"use_webdav\":\"1\",\"use_ldap\":\"1\"}"
    },
    "lang": {
        "Shinobi": "Shinobi",
        ...
        "SettingsChangedText": "Your settings have been saved and applied.",
        ...
        "StreamText": "<p>This section will designate the primary stream out method and it's settings. This stream will be displayed in the dashboard. If you choose to use HLS, JPEG, or MJPEG then you can consume the stream through other programs.</p><p class=\"h_st_input h_st_jpeg\">Using JPEG stream essentially turns off the primary stream and uses the snapshot bin to get frames.</p>",
                    ...
                    "info": [
                        {
                            ...
                            "possible": [
                                ...
                                {
                                    "name": "copy",
                                    "info": "Used for MP4 video. Has very low CPU usage but cannot use video filters and filesizes may be gigantic."
                                }
                            ]
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "description": "How long each segment should be. Each segment will be drawn by the client through an m3u8 file. Shorter is better, less space used.",
                            "default": "2",
                            "example": "3",
                            "possible": "1-23"
                        },
                    ...
                    "info": [
                        {
                            ...
                            "possible": [
                                {
                                    "name": "MP4",
                                    "info": "This file type is playable is almost all modern web browsers, that includes mobile. The filesize just tends to be gigantic unless you lower the quality."
                                },
                                {
                                    "name": "WebM",
                ...
                "Detector": {
                    ...
                    "info": [
                        ...
                        },
                        {
                            ...
                            "field": "Timeout Reset on Next Motion",
                        ...
                        },
                        {
                            ...
                            "description": "Save Motion Events in SQL. This will overlay object on top of video recorded during the time motion events occured.",
                            "default": "No",
                            "example": "",
                            "possible": ""
                        },
                        ...
                        },
                        {
                            ...
                            "description": "How many frames a second to send to the motion detector. 0.5 is the default. 0.5 means it will send a frame every 2 seconds.",
                            "default": "0.5",
                            "example": "",
                            "possible": ""
                        },
                        ...
                        },
                        {
                            ...
                            "possible": [
                                {
                                    "name": "No",
                                    "info": "Makes motion detector do nothing if regions are not specified."
                                },
                                {
                                    "name": "Yes",
                                    "info": "Read entire frame."
                                }
                            ]
                        },
                        {
                            ...
                            "field": "Indifference",
                            "description": "How much it doesn't care before doing something. The opposite of sensitivity. A lower number means it will trigger sooner. The value ranges up to 15(+) decimal places.",
                            "default": "0.5",
                            "example": "25",
                            "possible": "Any number."
                        },
                    ...
                    "info": [
                        {
                            ...
                            "possible": [
                                ...
                                {
                                    "name": "Debug",
                                    "info": "Show all information FFMPEG can provide on STDERR while doing the job."
                                }
                            ]
                        },
                        {
            ...
            "blocks": {
                "Profile": {
                    ...
                    "info": [
                        ...
                        {
                            "name": "detail=size",
                            "field": "Max Storage Amount",
                            "description": "The amount max space Shinobi will allow to be consumed before purging. This value is read in megabytes.",
                            "default": "10000",
                            "example": "600000",
                        ...
                        {
                            "name": "detail=days",
                            "field": "Number of Days to keep Videos",
                        ...
                        },
                        {
                            ...
                            "field": "Number of Days to keep Events",
                        ...
                        },
                        {
                            ...
                            "field": "Number of Days to keep Logs",
                ...
                "Monitor Groups": {
                    ...
                    "info": [
                        {
                            "field": "Groups",
                            "description": "The list of groups you have created.",
                            "default": "",
                            "example": "",
                            "possible": ""
                        },
                    ...
                    "info": [
                        {
                            ...
                            "field": "URL",
                            "description": "The connection URL for your WebDAV server.",
                            "default": "",
                            "example": "http://owncloud.server/remote.php/webdav/",
                            "possible": ""
                        },
                        {
                            "name": "detail=webdav_user",
                            "field": "Username",
                            "description": "The username required to access this server.",
                            "default": "",
                            "example": "",
                            "possible": ""
                        },
                        {
                            ...
                            "field": "Password",
                            "description": "The password required to access this server.",
                            "default": "",
                            "example": "",
                            "possible": ""
                        },
                        {
                            ...
                            "field": "Autosave",
                            "description": "Whether or not the server should auto upload videos as they are finished.",
                            "default": "No",
                            "example": "",
                            "possible": ""
                        },
                        {
                            ...
                            "description": "The directory where videos will be saved.",
                            "default": "/",
                            "example": "/videos",
                            "possible": ""
                        }
                    ...
                    "info": [
                        {
                            "name": "detail=css",
                            "field": "CSS",
                            "description": "Add custom colors to your dashboard. This field should only be used by advanced users.",
                            "default": "",
                            "example": "",
                            "possible": ""
                        }
    ...
    "addStorage": [
        {
            "name": "second",
            "path": "/home/training/git/shinobi/videos2/"
        }
    ],
    "fs": {
        "constants": {
